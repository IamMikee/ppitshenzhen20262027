			...
			<div className="relative font-montserrat">
				<div className="relative h-[110vh] -top-10">
					<Image
						src={PPITMobile}
						alt="PPIT Hero"
						className="sm:hidden block w-full h-full object-cover brightness-50"
						priority
						quality={90}
					/>
					<Image
						src={PPIT}
						alt="PPIT Hero"
						className="lg:block hidden w-full h-full object-cover brightness-50"
						priority
						quality={100}
					/>
					<Image
						src={PPITTablet}
						alt="PPIT Hero"
						className="lg:hidden sm:block hidden w-full h-full object-cover brightness-50"
						quality={75}
					/>
